...
It is re-implemented in JavaScript using Node.js as SPANG2.
...
\texttt{spang2 gene\_disease.rq --param disease=C0751955}

The template can be URL that returns a SPARQL query. The full usages of the command is as shown in Figure~\ref{fig:spang-command}.
