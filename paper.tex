...
afIn most cases, those queries are not accessible. According to the FAIR principle, resources should be accessible by through URI. In some cases, SPARQL queries are stored in repositories. But they do not have stable URIs. How about findability? 
...
To be accessible, resource should be retrievable by identifier, and metadata should be also available even if the resource are no longer available.
