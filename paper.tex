...
\begin{document}
%
\title{SPANG: a controlled query set with the FAIR principle}
%
...

{
  "disgenet": [
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/disgenet/gene_disease",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
        {
          "name": "arg1",
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/disgenet/get_gda",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
        {
          "name": "arg1",
    ...
    {
      "name": "list_gda_sources",
      "title": "List sources of gene-disease association",
      "uri": "http://localhost:7070/api/disgenet/list_gda_sources",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
    ...
    {
      "name": "list_gene_disease",
      "title": "List gene disease associations",
      "uri": "http://localhost:7070/api/disgenet/list_gene_disease",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
        {
          "name": "arg1",
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/disgenet/regex_disease",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
        {
          "name": "arg1",
    ...
    {
      "name": "uniprot2disease",
      "title": "Get diseases associated with given UniProt IDs",
      "uri": "http://localhost:7070/api/disgenet/uniprot2disease",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
    ...
    {
      "name": "uniprot2disease_curated",
      "title": "Get diseases associated with given UniProt IDs",
      "uri": "http://localhost:7070/api/disgenet/uniprot2disease_curated",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
    ...
    {
      "name": "uniprot2disease_curated_none",
      "title": "Get diseases associated with given UniProt IDs",
      "uri": "http://localhost:7070/api/disgenet/uniprot2disease_curated_none",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
    ...
    {
      "name": "uniprot2disease_none",
      "title": "Get diseases associated with given UniProt IDs",
      "uri": "http://localhost:7070/api/disgenet/uniprot2disease_none",
      "endpoint": "http://rdf.disgenet.org/sparql/",
      "param": [
  ...
  "general": [
    {
      "name": "find_term_uri",
      "title": "Find classes or properties (regex search for URIs or labels)",
      "uri": "http://localhost:7070/api/general/find_term_uri",
    ...
    {
      "name": "graphs_bug",
      "title": "SELECT DISTINCT ?graph, instead of GROUP BY ?graph, returns less results (Virtuoso 7.1.0)",
      "uri": "http://localhost:7070/api/general/graphs_bug",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    },
    {
      "name": "label",
      "title": "",
      "uri": "http://localhost:7070/api/general/label",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/general/link_select",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/general/regex_uri",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    },
    {
      ...
      "uri": "http://localhost:7070/api/general/search_for_class",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    {
      "name": "search_label_for_class",
      "title": "Free text search in Virtuoso",
      "uri": "http://localhost:7070/api/general/search_label_for_class",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
    ...
    {
      "name": "search_label_not_class",
      "title": "Free text search in Virtuoso (count instances of each class)",
      "uri": "http://localhost:7070/api/general/search_label_not_class",
      "endpoint": "http://dbpedia.org/sparql",
      "param": [
